...
<div class="item-time ">
	<div class="d-flex justify-content-around">
		...
		<img class="item-time__img" src="/img/setTime-32.png" onclick="location.href='./set-time';">
	</div>
	<div class="item-time__playing d-flex justify-content-center">
		...
		<img class="item-time__img" src="/img/updated-24.png" onclick="handlerTimePlay('<?=$kidName?>')">
	</div>
</div>