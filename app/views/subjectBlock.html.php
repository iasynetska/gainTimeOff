...
<div id = "inputSubjectBlock" class="item-subjects d-flex flex-column">
    <div id="formSubject" class="d-flex justify-content-between">
    	<input id="inputSubject" class="form__field form__field_width_80" placeholder="<?=$lg_new_subject?>" type="text" name="subject" min="2" max="20" oninput="removeBorderStyle(this)" />
