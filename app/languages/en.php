<?php
    return array (
        ...
        "lg_err_empty_name" => "Field Name is required!",
        "lg_err_name_letters" => "Only Latin and Polish letters with spaces are allowed!",
        "lg_err_login" => "The login must have between 3 and 20 characters!",
        "lg_err_alnum_login" => "The login may only consist of letters and numbers!",
        "lg_err_email" => "Provide a valid email address!",
        "lg_err_password" => "The password must have between 8 and 20 characters!",
