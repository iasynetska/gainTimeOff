<?php
    return array (
        ...
        "lg_err_length_1to2" => "The field must have between 1 and 2 characters!",
        ...
        "lg_err_num" => "The field may only consist of numbers!",
        "lg_err_date" => "Provide a valid date!",
